    ...
    <>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-5">
            {pillars.map((pillar) => (
              <div
                key={pillar.number}
                className="rounded-xl border border-gray-200 bg-ice p-6"
              >
      ...
      <section className="bg-white px-6 py-20 lg:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-4 max-w-3xl text-lg text-charcoal-light">
            ...
            {founders.map((founder, i) => (
              ...
              >
                ...
                <div className="flex shrink-0 items-center justify-center">
                  <div className="h-48 w-48 rounded-2xl bg-ice" />
                </div>
                {/* Bio */}
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-base font-medium text-teal">
                    {founder.role}
                  </p>
